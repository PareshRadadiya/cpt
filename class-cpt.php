...
class CptSettings {
    ...
    function __construct() {
        ...
        add_action('admin_init', array($this, 'add_event_caps')); //Register all CPT added using this plugin
    }
    ...
    function register_cpt() {
        if ($this->options) {
            foreach ($this->options as $value) {
                $x = register_post_type($value['cpt_post_type'], array(
                    'labels' => array(
                    ...
                    // 'capabilities' => $value['cpt_capabilities'],
...
//
//            $cpt_capabilities = array();
//
//            if (isset($_POST["cpt_capabilities"])) {
//                foreach ($_POST["cpt_capabilities"] as $value) {
//                    // $cpt_capabilities[$value]=  preg_replace("/(post.*)/",$_POST["cpt_post_type"],$value); //change in case of specific capability is specified
//                    // $cpt_capabilities[$value] = str_replace("post", $_POST["cpt_post_type"], $value);
//                    $cpt_capabilities[$value] = $value;
//                }
//            }
            ...
            // $cpt_option[$_POST["cpt_post_type"]]["cpt_capability_type"] = isset($_POST["cpt_capability_type"]) ? $_POST["cpt_capability_type"] : array('post');
           // $cpt_option[$_POST["cpt_post_type"]]["cpt_capabilities"] = isset($_POST["cpt_capabilities"]) ? $cpt_capabilities : array('');
